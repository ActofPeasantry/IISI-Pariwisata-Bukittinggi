...
FROM souvenir, city
where st_contains(city.geom, souvenir.geom) and souvenir.id='$id'";
...
?>
        ...
        </table> <!-- <a href="printitinerary.php?id=<?php echo $id_package; ?>" target="_blank"><b>Print</b></a> -->
...
<?php
  ...
  $hasil=pg_query($querysearch);
    ...
    while($baris1 = pg_fetch_assoc($hasil))
      {
        if(($baris1['gallery_souvenir']=='-')||($baris1['gallery_souvenir']==''))
        {
            echo "<a href='foto/foto.jpg'><img src='foto/foto.jpg' ></a>";
        }
        else
        {
                echo "<a href='foto/".$baris1['gallery_souvenir']."'><img src='foto/".$baris1['gallery_souvenir']."'></a>";
        }
    ?>
...
<!--               <a href="index.php" class="go-top"> -->
  ...
  <script src="assets/js/fancybox/jquery.fancybox.js"></script>    
   ...
   <script type="text/javascript">
   detailsouvenir('<?php echo $_GET["id_souvenir"]; ?>')
   </script>

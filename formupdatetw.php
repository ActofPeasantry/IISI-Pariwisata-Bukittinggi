        ...
        <div class="message_inner" style="height:560px;overflow:auto;">
          <div class="message_widgets">
            ...
            <div class="form-group row">
              <form role="form" method="post" action="saveupdatetw.php" enctype="multipart/form-data">
              <?php if (isset($_GET['id']))
              {
                $id=$_GET['id'];
                $sql = pg_query("SELECT id, name, address, open, close, ticket, description, id_city, ST_AsText(geom) as geom FROM tourism where id='$id'" );
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-7">
                <input name="description" class="form-control" type="text" value="<?php echo $data['description']?>" >
              </div>
            </div>

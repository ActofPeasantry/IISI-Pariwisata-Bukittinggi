...
<section id="main-content">
  <section class="wrapper">
      ...
      <div class="row">
        ...
        <a href="formmasjid.php" class="btn btn-default"><i class="fa fa-plus"></i> ADD DATA</a>
        </div>
          ...
          <table id="" class="table table-hover table-bordered table-striped">
            <thead>
              ...
              <tr>
                ...
                <td><?php echo "$aksi" ?>
                <a href="formupdatemasjid.php?id=<?php echo $id?>" class="btn btn-success"> UPDATE </a>
                <div class="btn-group">
                <a href="hapusmasjid.php?id=<?php echo $id; ?>" onclick="return confirm ('delete?')"  class="btn btn-success"> DELETE </a>
                </tr>

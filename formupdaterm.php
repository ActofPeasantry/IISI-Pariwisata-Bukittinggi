...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="mapdrawrm.js"></script>
...
<section id="main-content">
  ...
  <div class="col-md-12"  id="tampilrute" style="display:none;" >
    <div class="panel text-white" style="background-color:purple">
      <div class="panel-body">
        <div class="col-md-12 padding-0 text-center">
          <h3 style="font-size:16px">ROUTE OF YOUR DESTINATION</h3>                  
        </div>
      </div>
    </div>
  <div class="panel box-v3">
    <div class="panel-body">
      <div class="form-group">
        <table class="table table-bordered" id='tampilrutesemua'></table>
      </div>
    </div>
  </div>
  </div>
        ...
        <div class="message_inner" style="height:560px;overflow:auto;">
          <div class="message_widgets">
            ...
            <div class="form-group row">
              <form role="form" method="post" action="saveupdaterm.php" enctype="multipart/form-data">
              <?php if (isset($_GET['id']))
              {
                $id=$_GET['id'];
                $sql = pg_query("SELECT id, name, address, open, close, price, description, id_city, ST_AsText(geom) as geom FROM restaurant where id='$id'" );
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-7">
                <input name="address" class="form-control" type="text" value="<?php echo $data ['address']?>" required>
              </div>
            </div>
            ...
            <div class="form-group">
                ...
                <select required name="id_city" id="id_city" class="form-control">
                  <?php
                    $id = pg_query("select * from city");
                    while($row1 = pg_fetch_assoc($id))
                    {
                      if($data[id]==$row1[id]){
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-7">
                <input name="open" class="form-control" type="time" value="<?php echo $data ['open']?>" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              <label for="close" class="col-sm-5 col-form-label">Close Hour
                ...
                <div class="col-sm-7">
                  <input name="close" class="form-control" type="time" value="<?php echo $data ['close']?>" required>
                </div>
            </div>

            <div class="form-group row">
              <label for="price" class="col-sm-5 col-form-label">Price
                <span class="required"></span>
              </label>
              <div class="col-sm-7">
                <input name="price"class="form-control" type="text" value="<?php echo $data ['price']?>" required>
              </div>
            </div> 
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-7">
                <input name="description" class="form-control" type="text" value="<?php echo $data ['description']?>" required>
              </div>
            </div>

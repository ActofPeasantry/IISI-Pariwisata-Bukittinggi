        ...
        <div class="message_inner" style="height:560px;overflow:auto;">
          <div class="message_widgets">
            ...
            <div class="form-group row">
              <form method="POST" name = "form_input" action="simpanindustribaru.php" enctype="multipart/form-data">
                <?php
            ...
            <div class="form-group row">
              <label for="example-tel-input" class="col-sm-5 col-form-label">Open Hour 
                <span style="color:green">*</span>
              </label>
              <div class="col-sm-7">
            ...
            <div class="form-group row">
              <label for="example-tel-input" class="col-sm-5 col-form-label">Close Hour
                <span style="color:green">*</span>
              </label>
                <div class="col-sm-7">
            ...
            <div class="form-group row">
              <label for="example-tel-input" class="col-sm-5 col-form-label">Description</label>
              <div class="col-sm-7">

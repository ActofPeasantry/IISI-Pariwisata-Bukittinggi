...
?>
 ...
 <!--            <tr><td width="150px"><b>Password</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $password ?></td></tr>             -->
        ...
        <form method="POST" action="agenupdateinfo.php">
        <div class="btn-group">
          ...
          <?php 
               ...
               //   $id = $_GET["id_travel"];
                 //     echo "ini $id";
                  ...
                  $sqlreview = "SELECT * from info where id_travel = '$id_travel'";
                      ...
                      while ($rows = pg_fetch_array($result)) 
                        {
                          ...
                          echo "<tr><td>$tgl</td><td>$info</td><td><a href='info_delete2.php?id_info=$id_info' class='btn btn-sm btn-default' title='Delete'><i class='fa fa-trash-o'></i></a></td></tr>";
                        }

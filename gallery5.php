...
ST_X(ST_Centroid(workship_place.geom)) AS longitude, 
ST_Y(ST_CENTROID(workship_place.geom)) As latitude
 ...
 <?php
  ...
  $hasil=pg_query($querysearch);
    ...
    while($baris1 = pg_fetch_assoc($hasil))
      {
        if(($baris1['gallery_workship_place']=='-')||($baris1['gallery_workship_place']==''))
        {
            echo "<a href='foto/foto.jpg'><img src='foto/foto.jpg' ></a>";
        }
        else
        {
                echo "<a href='foto/".$baris1['gallery_workship_place']."'><img src='foto/".$baris1['gallery_workship_place']."'></a>";
        }
    ?>
...
<!--               <a href="index.php" class="go-top"> -->
  ...
  <script src="assets/js/fancybox/jquery.fancybox.js"></script>    
   ...
   <script type="text/javascript">
   detailmasjid('<?php echo $_GET["id_masjid"]; ?>')
   </script>

...
include"connect.php";
    ...
    //query UPDATE
	$query = pg_query("UPDATE tourism SET name='$name', address='$address', open='$open', close='$close', ticket=$ticket, description='$description', id_city='$id_city', geom=ST_GeomFromText('$geom') WHERE id='$id'"); 
    echo $query;

...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="mapdrawindustri.js"></script>
    <script type="text/javascript">

    var server = "http://localhost/pariwisata/";
    </script>
    <style>
...
<div class="panel-body text-center" style="height:450px">
  ...
  <div class="col-lg-5 ds">
      ...
      <div class="panel-body" style="height:580px;">
        <div class="message_inner" style="height:480px;overflow:auto;">
          <div class="message_widgets">
            <div class="form-group row">
              <form role="form" method="post" action="saveupdateindustri.php" enctype="multipart/form-data">
              <?php if (isset($_GET['id']))
              {
                $id=$_GET['id'];
                $sql = pg_query("SELECT id, name, address, open, close, description, id_city, ST_AsText(geom) as geom FROM souvenir where id='$id'" );
              ...
              ?>
                ...
                <input name="id"class="form-control hidden" type="text" value="<?php echo $id?>" id="id">
                  <label for="geom" class="col-sm-5 col-form-label">Coordinat

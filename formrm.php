          ...
          <div class="panel box-v3">
            <div class="panel-body">
              <div class="form-group">
                <table class="table table-bordered" id='tampilrutesemua'>
                </table>
              </div>
            </div>
          </div>
              ...
              <div class="message_inner" style="height:560px;overflow:auto;">
                <div class="message_widgets">
                  ...
                  <div class="form-group row">
                    <form method="POST" name="form_input" action="simpanrmbaru.php" enctype="multipart/form-data">
                      <?php
                      ...
                      ?>
                      <?php var_dump($idmax);?>
                      <input name="id" class="form-control" type="text" value="<?php echo $idmax; ?>" id="id" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                      <input name="price" class="form-control" type="text" value="" id="price">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                      <input name="description" class="form-control" type="text" value="" id="description">
                    </div>
                  </div>

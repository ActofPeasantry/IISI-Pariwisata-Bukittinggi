...
include '../inc/connect.php';
    ...
    //query UPDATE
	$query = pg_query("UPDATE event SET name='$name', address='$address', date='$date', open='$open', close='$close', ticket=$ticket, id_city='$id_city', id_event_type='$id_event_type' id_organizer='$id_organizer', geom=ST_GeomFromText('$geom')  WHERE id='$id'");

...
// 	$id = $_POST['id'];
// 	$querysearch="select serial_number from tourism_gallery where id_tourism='$id' order by serial_number desc limit 1";
...
// 		$sql = pg_query("insert into tourism_gallery values('$serial_number','$name','$id')");
// 		if($sql)
// 		{

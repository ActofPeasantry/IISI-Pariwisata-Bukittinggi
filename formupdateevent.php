        ...
        <div class="message_inner" style="height:560px;overflow:auto;">
          <div class="message_widgets">
            ...
            <div class="form-group row">
              ...
              {
                $id=$_GET['id'];
                $sql = pg_query("SELECT id, name, address, date, open, close, ticket, id_city, id_event_type, id_organizer, ST_AsText(geom) as geom FROM event where id='$id'" );
              ...
              <form role="form" method="post" action="saveupdateevent.php" enctype="multipart/form-data">

            ...
            <thead>
              ...
              <tr>
                ...
                <td><?php echo "$aksi" ?>
                  ...
                  <a href="formupdatetw.php?id=<?php echo $id?>" class="btn btn-success"> UPDATE </a>
                  <a href="hapustw.php?id=<?php echo $id; ?>" onclick="return confirm ('delete?')"  class="btn btn-success"></i> DELETE </a>
              </tr>
            <?php
            }
            ?>

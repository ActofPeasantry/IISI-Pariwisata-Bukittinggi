  ...
  <section class="wrapper">
    ...
    <div class="col-lg-5 ds">
      ...
      <div class="form-group row">
        <form role="form" method="post" action="saveupdatemasjid.php" enctype="multipart/form-data">
        <?php if (isset($_GET['id']))
              {
                $id=$_GET['id'];
                $sql = pg_query("SELECT id, name, address, id_city, ST_AsText(geom) as geom FROM workship_place where id='$id'" );
      ...
      <div class="form-group row">
        <label for="example-text-input" class="col-sm-5 col-form-label">Name 
          <span style="color:green">*</span>
        </label>
        <div class="col-sm-7">
          <input name="name"class="form-control" type="text" value="" value="<?php echo $data ['name']?>" required>
        </div>
      </div>

      <div class="form-group row">
        <label for="example-text-input" class="col-sm-5 col-form-label">Address 
          <span style="color:green">*</span>
        </label>
        <div class="col-sm-7">

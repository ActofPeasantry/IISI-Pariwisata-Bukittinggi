...
<section id="main-content">
  <section class="wrapper">
      ...
      <div class="row">
        ...
        <a href="formrm.php" class="btn btn-default"><i class="fa fa-plus"></i> ADD DATA</a>
        </div>
          ...
          <table id="" class="table table-hover table-bordered table-striped">
            <thead>
              ...
              <tr>
                ...
                <td><?php echo "$aksi" ?>
                <a href="formupdaterm.php?id=<?php echo $id?>" class="btn btn-success"> UPDATE </a>
                <a href="hapusrm.php?id=<?php echo $id; ?>" onclick="return confirm ('delete?')"  class="btn btn-success"></i> DELETE </a>
                </tr>
